            ...
            <div className="card mx-auto w-full max-w-5xl shadow-2xl">
                <div className="grid md:grid-cols-2 grid-cols-1 bg-base-100 rounded-xl">
                        ...
                        <div className="hero min-h-full rounded-l-xl bg-base-200">
                            <div className="hero-content py-8">
                                <div className="max-w-md">
                                    <h1 className="mb-10 text-center font-bold text-lg"> ورود به پنل اتوبوس دار</h1>
                    ...
                    <div className="flex flex-col bg-white px-4 sm:px-6 md:px-8 lg:px-10 py-8 w-full max-w-md m-auto">
                        <div className="font-medium self-center text-xl sm:text-2xl uppercase text-gray-800">ورود به پنل اتوبوس دار</div>
                                ...
                                <div className="flex flex-col mb-1">
                                    ...
                                    <div className="flex items-center mb-6">
                                        <div className="flex ml-auto">
                                            <a href="/drivers/forgot-password" className="inline-flex text-xs font-bold sm:text-sm text-blue-800 hover:text-blue-900">پسورد خود را فراموش کردید؟</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className='text-center mt-4'>حساب ندارید؟ <a href="/drivers/register" className='no-underline hover:text-blue-900'><button className="inline-block hover:cursor-pointer transition duration-200"> ثبت نام </button></a></div>
