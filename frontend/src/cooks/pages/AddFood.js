...
function AddFood() {
    ...
    const addFoodHandle = (e) => {
        ...
        if (!cookName || cookName === "" || cookName === undefined || cookName === null) {
            ...
            axios.post(`/api/cooks/foods`, formData, {
                headers: {
        ...
        <>
            <TitleCard title="افزودن غذا" topMargin="mt-2">
                <div className="mx-auto">
                    ...
                    {/*  food photo  */}
                    <div className="flex flex-col mb-6">
                        <label htmlFor="photo" className="mb-2 text-xs sm:text-sm tracking-wide text-gray-600">تصویر اصلی غذا </label>
                    ...
                    {/* food photos */}
                    <div className="flex flex-col mb-6">
                        <label htmlFor="photo" className="mb-2 text-xs sm:text-sm text-gray-600">تصاویر غذا </label>
                        <div className="grid grid-cols-1 md:grid-cols-3 border border-gray-300 rounded-md py-2 focus:outline-none focus:border-blue-800">
                            <div className="flex items-center">
                                <button
                                    type="button"
