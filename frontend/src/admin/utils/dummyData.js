...
module.exports = Object.freeze({
    ...
    RECENT_TRANSACTIONS : [
        {name: "کاربر یک", avatar: "https://cdn-icons-png.flaticon.com/128/4140/4140037.png",  id:Math.floor(Math.random() * 1000000000000000000),email : "user@two.com", location : "اصفهان", amount : "۱۰۰۰۰", date :  MomentJalali(new Date()).add(-5 * 1, 'days').format("jYYYY/jMM/jDD")},
        {name: "کاربر دو", avatar: "https://cdn-icons-png.flaticon.com/128/4140/4140037.png", id:Math.floor(Math.random() * 1000000000000000000),email : "ereena@dashwind.com", location : "یاسوج", amount : "۱۹۰۰۰۰", date : MomentJalali(new Date()).add(-5 * 1, 'days').format("jYYYY/jMM/jDD")},
        {name: "کاربر سه", avatar: "https://cdn-icons-png.flaticon.com/128/4140/4140037.png", id:Math.floor(Math.random() * 1000000000000000000),email : "jhon@dashwind.com", location : "بوشهر", amount : "۶۴۵۰۰۰", date :  MomentJalali(new Date()).add(-5 * 1, 'days').format("jYYYY/jMM/jDD")},
        {name: "کاربر چهار", avatar: "https://cdn-icons-png.flaticon.com/128/4140/4140037.png", id:Math.floor(Math.random() * 1000000000000000000),email : "matrix@dashwind.com", location : "ساری", amount : "۴۵۰", date :  MomentJalali(new Date()).add(-5 * 1, 'days').format("jYYYY/jMM/jDD")},
        {name: "کاربر پنج", avatar: "https://cdn-icons-png.flaticon.com/128/4140/4140037.png", id:Math.floor(Math.random() * 1000000000000000000),email : "virat@dashwind.com", location : "ری", amount : "۹۸۷۴۵۳۱۲", date :  MomentJalali(new Date()).add(-5 * 1, 'days').format("jYYYY/jMM/jDD")},
        {name: "کاربر شش", avatar: "https://cdn-icons-png.flaticon.com/128/4140/4140037.png", id:Math.floor(Math.random() * 1000000000000000000),email : "miya@dashwind.com", location : "اسفراین", amount : "۲۱۳", date :  MomentJalali(new Date()).add(-5 * 1, 'days').format("jYYYY/jMM/jDD")},
