...
const SingleUserTicket = () => {
    let { userId, stId } = useParams();
    ...
    const handleAddComment = () => {
        ...
        axios.put(`/api/admins/users/${userId}/support-tickets/${stId}/add-comment`, { comment: newComment }, {
            headers: {
    ...
    useEffect(() => {
        ...
        axios.get(`/api/admins/users/${userId}/support-tickets/${stId}`, { headers: { authorization: AuthStr } })
            .then(response => {
