            ...
            <div className="card mx-auto w-full max-w-5xl shadow-2xl">
                <div className="grid md:grid-cols-2 grid-cols-1 bg-base-100 rounded-xl">
                        ...
                        <div className="hero min-h-full rounded-l-xl bg-base-200">
                            <div className="hero-content py-8">
                                <div className="max-w-md">
                                    <h1 className="mb-10 text-center font-bold text-lg"> ثبت نام در پنل ملک دار</h1>
                    ...
                    <div className="flex flex-col bg-white px-4 sm:px-6 md:px-8 lg:px-10 py-8 w-full max-w-md m-auto">
                        <div className="font-medium self-center text-xl sm:text-2xl uppercase text-gray-800">ثبت نام در پنل ملک دار</div>
                        ...
                        <div className='text-center mt-4'>حساب دارید؟ <a href="/owners/login" className='no-underline hover:text-blue-900'><button className="inline-block hover:cursor-pointer transition duration-200"> ورود</button></a></div>
